...
از نسخه **1.1.0** وب‌سایت و Portal قدیمی یکی شده‌اند. در **1.2.0** کل Website App یک UI Overhaul کامل گرفته: Dashboard، Orders، Wallet، Referral، Profile و محصولات عمومی درشت‌تر، خواناتر، متحرک و Responsive شده‌اند. Storefront V9 رابط اصلی وب است و Mini App تلگرام عمداً ظاهر مستقل خودش را حفظ کرده است.
